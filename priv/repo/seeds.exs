...
cabins = [
  %{
    ...
    description:
      "Évadez-vous de la ville et découvrez la tranquillité de la nature en séjournant dans notre cabane perchée dans les arbres. Vous pourrez profiter d'une vue imprenable sur la canopée et écouter les bruits de la forêt la nuit. Cette expérience unique en son genre vous offrira un séjour inoubliable.",
    max_guests: 4,
    area: "Bruxelles",
    price: 80,
    city: "Bruxelles"
  ...
  %{
    ...
    description:
      "Imaginez-vous surplombant la canopée des arbres depuis votre propre cabane perchée dans les hauteurs. Notre cabane offre une expérience de vie en harmonie avec la nature, avec le confort moderne pour que vous puissiez profiter de la vue imprenable tout en ayant toutes les commodités nécessaires pour passer un séjour agréable.",
    max_guests: 6,
    area: "Wallonie",
    price: 45,
    city: "Liège"
  ...
  %{
    ...
    description:
      "Nous vous invitons à venir séjourner dans notre cabane perchée dans les arbres, une expérience unique et inoubliable. Vous serez entouré d'une nature luxuriante, avec une vue imprenable sur la forêt environnante. Vous pourrez observer les animaux sauvages depuis votre terrasse privée, pour un moment de calme et de détente.",
    max_guests: 4,
    area: "Wallonie",
    price: 90,
    city: "Namur"
  ...
  %{
    ...
    description:
      "Offrez-vous une expérience unique en passant la nuit dans notre cabane perchée dans les arbres. Vous pourrez admirer la vue imprenable sur la canopée depuis votre terrasse privée, et vous serez bercé par les sons de la nature toute la nuit. Cette expérience unique vous offrira une immersion totale dans la nature, pour un séjour inoubliable.",
    max_guests: 4,
    area: "Wallonie",
    price: 110,
    city: "Charleroi"
  ...
  %{
    ...
    description:
      "Envie d'une expérience unique et hors du commun ? Optez pour notre cabane perchée dans les arbres, qui vous offrira une vue spectaculaire sur la nature environnante. Vous pourrez observer les oiseaux et autres animaux sauvages depuis votre terrasse privée, pour une expérience en harmonie avec la nature.",
    max_guests: 6,
    area: "Wallonie",
    price: 75,
    city: "Tournai"
  ...
  %{
    ...
    description:
      "Nichée dans les arbres, notre cabane offre une expérience immersive dans la nature, avec tout le confort moderne que vous pourriez souhaiter. Profitez de la vue imprenable sur les arbres, écoutez les bruits de la nature et relaxez-vous dans ce havre de paix, loin de l'agitation de la ville.",
    max_guests: 4,
    area: "Flandres",
    price: 49,
    city: "Gand"
  ...
  %{
    ...
    description:
      "Venez découvrir la magie de notre cabane perchée dans les arbres, qui vous offrira une expérience unique de vie en pleine nature. Vous pourrez observer les étoiles depuis votre terrasse privée, et vous réveiller au son des oiseaux le matin. Une expérience immersive et relaxante à ne pas manquer.",
    max_guests: 3,
    area: "Flandres",
    price: 69,
    city: "Anvers"
  ...
  %{
    ...
    description:
      "Pour une expérience de vie en harmonie avec la nature, notre cabane perchée dans les arbres est l'endroit idéal. Vous pourrez profiter d'une vue imprenable sur les arbres et la forêt environnante, tout en étant confortablement installé dans votre cabane. Une expérience unique et inoubliable vous attend.",
    max_guests: 4,
    area: "Flandres",
    price: 75,
    city: "Mechelen"
  ...
  %{
    ...
    description:
      "Notre cabane perchée dans les arbres offre une expérience unique de vie en pleine nature. Située en hauteur, vous aurez une vue imprenable sur les arbres et la forêt environnante. Profitez de la tranquillité de la nature tout en étant confortablement installé dans votre cabane.",
    max_guests: 5,
    area: "Flandres",
    price: 60,
    city: "Leuven"
  ...
  %{
    name: "Le Nid d'Aigle",
    description:
      "Nichée au sommet des arbres, notre cabane vous offre une vue imprenable sur la nature environnante. Vous pourrez observer les étoiles la nuit depuis votre terrasse privée, et vous réveiller au son des oiseaux le matin. Une expérience unique de vie en pleine nature vous attend.",
    max_guests: 2,
    area: "Flandres",
    price: 45,
    city: "Leuven"
  ...
  %{
    ...
    description:
      "Vivez une expérience immersive dans la nature en séjournant dans notre cabane perchée dans les arbres. Vous pourrez observer les animaux sauvages et les oiseaux depuis votre terrasse privée, tout en étant confortablement installé dans votre cabane. Un séjour relaxant et inoubliable en perspective.",
    max_guests: 4,
    area: "Flandres",
    price: 120,
    city: "Hasselt"
  ...
  %{
    ...
    description:
      "Éloignez-vous de la ville et découvrez la sérénité de la nature en séjournant dans notre cabane perchée dans les arbres. Vous pourrez profiter d'une vue imprenable sur la forêt environnante, tout en étant confortablement installé dans votre cabane. Une expérience unique et paisible vous attend.",
    max_guests: 2,
    area: "Flandres",
    price: 80,
    city: "Mechelen"
  ...
  %{
    ...
    description:
      "Notre cabane perchée dans les arbres vous offre une expérience immersive dans la nature, avec tout le confort moderne que vous pourriez souhaiter. Profitez de la vue imprenable sur la canopée, écoutez les bruits de la forêt et détendez-vous dans ce havre de paix, loin du stress de la vie quotidienne.",
    max_guests: 3,
    area: "Flandres",
    price: 55,
    city: "Genk"
